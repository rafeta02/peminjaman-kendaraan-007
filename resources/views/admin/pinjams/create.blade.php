        ...
        <form method="POST" action="{{ route("admin.pinjams.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('driver_status') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="driver_status" id="driver_status" value="1" {{ old('driver_status', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('key_status') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="key_status" id="key_status" value="1" {{ old('key_status', 0) == 1 ? 'checked' : '' }}>
