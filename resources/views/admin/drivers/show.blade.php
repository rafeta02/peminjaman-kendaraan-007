...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#driver_kendaraans" role="tab" data-toggle="tab">
                {{ trans('cruds.kendaraan.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="driver_kendaraans">
            @includeIf('admin.drivers.relationships.driverKendaraans', ['kendaraans' => $driver->driverKendaraans])
        </div>
    </div>
</div>
