                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pinjams.update", [$pinjam->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_start" id="date_start" value="{{ old('date_start', $pinjam->date_start) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_end" id="date_end" value="{{ old('date_end', $pinjam->date_end) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_return" id="date_return" value="{{ old('date_return', $pinjam->date_return) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="driver_status" id="driver_status" value="1" {{ $pinjam->driver_status || old('driver_status', 0) === 1 ? 'checked' : '' }}>
