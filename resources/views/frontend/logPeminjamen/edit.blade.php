    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.log-peminjamen.update", [$logPeminjaman->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="log" id="log">{!! old('log', $logPeminjaman->log) !!}</textarea>
                            @if($errors->has('log'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('log') }}
                                </div>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.log-peminjamen.storeCKEditorImages') }}', true);
